...
Your new workspace contains a member crate for each of the web, desktop and mobile platforms, and `core` and `ui` crates that are shared between multiple platforms:

```
packages/
├─ core/
│  ├─ ... # Core logic shared between multiple platforms
├─ ui/
